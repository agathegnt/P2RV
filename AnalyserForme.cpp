...
//d�termine si un trait est presque un segment ou non
...
//cherche pr�s de quels points importants de la liste de formes se trouve p, et retourne le point le plus int�ressant (si il existe)
...
Segment AnalyseSegment(Segment* seg, vector<Forme*> liste, int n, int distancemaxpoints, int W, int H){
	...
	//si pas trouv�s, recherche de perpendiculaire
	if(!or){
	...
	//si pas de points trouv�s, recherche de parall�les
